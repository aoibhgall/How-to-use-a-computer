...
I use vscode to edit LaTeX locally. Go to the vscode page to follow the instructions for setting up vscode for latex. 
 ...
 I will add my template to the repo, when I get around to it 


 ## Writing scientific papers with LaTeX

 I will include a general template later when I get around to it. 

 Here I will also document how some things work and how I sue them. 
